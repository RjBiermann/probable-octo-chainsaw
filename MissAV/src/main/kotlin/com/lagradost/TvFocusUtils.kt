...
object TvFocusUtils {
    ...
    private fun isAutoTvDevice(context: Context): Boolean {
        ...
        if (uiModeManager == null) {
            Log.w(TAG, "UiModeManager service unavailable, falling back to device model detection")
        } else if (uiModeManager.currentModeType == Configuration.UI_MODE_TYPE_TELEVISION) {
            return true
        }
