...
class SevenMmTvPlugin : Plugin() {
    companion object {
        internal const val STORAGE_KEY = "SEVENMMTV_CUSTOM_PAGES"
        internal const val LEGACY_PREFS_NAME = "sevenmmtv_plugin_prefs"

        fun createRepository(tag: String = "SevenMmTv") = GlobalStorageCustomPagesRepository(
    ...
    override fun load(context: Context) {
        val repository = createRepository("SevenMmTvPlugin")
        ...
        openSettings = { ctx ->
            ...
            if (activity != null && !activity.isFinishing && !activity.isDestroyed) {
                SevenMmTvSettingsFragment().show(activity.supportFragmentManager, "SevenMmTvSettings")
            }
        }
